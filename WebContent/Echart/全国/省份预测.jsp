...
<html style="height: 100%">
   ...
   String Yu_province=request.getParameter("Yu_province");
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/static/jquery-1.12.1.js"></script>
       ...
       option = {
    		   title: {
    		        text: '根据最小二乘法预测未来'+'<%=Yu_province%>'+'疫情走向',
    		        subtext: '数据来源：健康委员会官网'
    		    },
           tooltip: {
               trigger: 'axis',
               axisPointer: {
...
$.ajax({
    ...
    data:
    	{
    	"method":"china_yu_province",
    	"Yu_province":"<%=Yu_province%>"
    	},
    dataType:"json",
