...
<body >
	...
	<div class="row-fluid" style="margin-top: 100px;">
		...
		<div class="col-md-4">
			<form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/Echart/全国/省份预测.jsp"
				method="post" id="checkForm" target="myFrameName">
				
					<div class="form-group">
					<label class="col-md-3 control-label" for="tags">预测省份</label>
					<div class="col-md-9">
						<input class="form-control" name="Yu_province" type="text" id="tags"
							placeholder="例如“河北”" value="" />
					</div>
				</div>
